...
class CrossAttention(nn.Module):
    ...
    def forward(self, 
        ...
        k = self.k_proj(context).reshape(B, context.shape[1], self.num_heads, self.head_dim).transpose(1, 2)
        v = self.v_proj(context).reshape(B, context.shape[1], self.num_heads, self.head_dim).transpose(1, 2)
